                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    <div className="md:col-span-1">
                        <p className="text-gray-600 leading-relaxed mb-6 max-w-md">
                            We are your trusted healthcare partner, delivering secure, seamless access to qualified doctors and simplifying appointment scheduling for patients through a reliable, user-friendly healthcare platform.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            ...
                            <li className="flex items-start">
                                ...
                                <div>
                                    <p className="text-gray-700 font-medium">hello@selfsevya.com</p>
                            ...
                            <li className="flex items-start">
                                ...
                                <div>
                                    <p className="text-gray-700 font-medium">112 Medical Drive</p>
                                    <p className="text-sm text-gray-500 mt-1">New Delhi, ND 10001</p>
                                </div>
                            </li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <form className="flex flex-col space-y-3">
                            ...
                            <button
                                type="submit"
                                className="bg-[#1e6b8f] hover:bg-[#0c4a6e] text-white px-6 py-3 rounded-lg transition-all flex items-center justify-center space-x-2"
                            >
                                <span>Subscribe</span>
                        ...
                        <p className="text-xs text-gray-500 mt-3">We respect your privacy.</p>
                    </div>
                </div>
                ...
                <div className="border-t border-gray-200 pt-8">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        <p className="text-gray-500 text-sm mb-4 md:mb-0">
                            &copy; {new Date().getFullYear()} SelfSevya. All rights reserved.
                        </p>
                        ...
                        <p className="text-gray-500 text-sm mt-4 md:mt-0">
                            ...
                            <a
                                href="https://www.linkedin.com/in/hariom-tiwari-4450a92b6"
